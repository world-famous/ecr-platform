package com.tianwen.springcloud.microservice.base;
...
public class TwSpringCloudMicroserviceBaseApplication
{
    public static void main(String[] args)
    {
        System.out.println("TwSpringCloudMicroserviceBaseApplication before");

        BasicConfigurator.configure();
        SpringApplication.run(TwSpringCloudMicroserviceBaseApplication.class, args);

        System.out.println("TwSpringCloudMicroserviceBaseApplication after");
    }
}
